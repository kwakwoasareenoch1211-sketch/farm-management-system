...
<div class="inv-card p-4">
    <h2 class="fw-bold mb-3">Edit Medication Record</h2>

    <form method="POST" action="<?= rtrim(BASE_URL, '/') ?>/medication/update">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="medication_name" class="form-control" value="<?= htmlspecialchars($record['medication_name'] ?? '') ?>" required>
            </div>

            <div class="col-md-4">
                <label class="form-label">Quantity Used</label>
                <input type="number" step="0.01" min="0" name="quantity_used" class="form-control" value="<?= htmlspecialchars($record['quantity_used'] ?? '0') ?>" required>
            </div>

            <div class="col-md-4">
                <label class="form-label">Unit Cost</label>
                <input type="number" step="0.01" min="0" name="unit_cost" class="form-control" value="<?= htmlspecialchars($record['unit_cost'] ?? '0') ?>">
            </div>
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-dark">Update Medication Record</button>
