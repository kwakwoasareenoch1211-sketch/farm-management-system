<div class="work-card p-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h2 class="fw-bold mb-1">Add Egg Production Record</h2>
            <p class="text-muted mb-0">Save daily egg output and automatically update production metrics.</p>
        </div>
    ...
    <form method="POST" action="<?= rtrim(BASE_URL, '/') ?>/egg-production/store">
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="number" name="cracked_quantity" class="form-control" value="0">
            </div>

            <div class="col-md-3">
                <label class="form-label">Spoiled Quantity</label>
                <input type="number" name="spoiled_quantity" class="form-control" value="0">
            </div>

            <div class="col-md-3">
                <label class="form-label">Average Weight (grams)</label>
                <input type="number" step="0.001" name="average_weight_grams" class="form-control">
            </div>
